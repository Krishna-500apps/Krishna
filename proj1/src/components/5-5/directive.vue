  ...
  <b-container fluid>
    <b-row>
      <b-col cols="4">
        ...
        <b-list-group v-b-scrollspy:listgroup-ex v-b-visible="handleVisibility">
          ...
          <b-list-group-item href="#list-item-6">Item 6</b-list-group-item>
        </b-list-group>
      </b-col>

      <b-col cols="8">
        <div id="listgroup-ex" style="position:relative; overflow-y:auto; height:300px" :class="[isVisible ? 'bg-info' : 'bg-light', 'border', 'p-2', 'text-center']">
          ...
          <p v-b-visible="handleVisibility"></p>
          <p>{{ text }}</p>
